...
internal partial class Shop : Form
{
    internal Shop()
    {
        InitializeComponent();
    ...
    private void upshopth()
    {
        ...
        {
            button1.Text = "Adder " + add1u.rankvalue + "\r\n$" + add1u.cache;
            button2.Text = "Adder " + add2u.rankvalue + "\r\n$" + add2u.cache;
            button3.Text = "Adder " + add3u.rankvalue + "\r\n$" + add3u.cache;
            button4.Text = "Adder " + add4u.rankvalue + "\r\n$" + add4u.cache;
            button5.Text = "Adder " + add5u.rankvalue + "\r\n$" + add5u.cache;
            button6.Text = "Adder " + add6u.rankvalue + "\r\n$" + add6u.cache;
            button7.Text = "Adder " + add7u.rankvalue + "\r\n$" + add7u.cache;
            button8.Text = "Adder " + add8u.rankvalue + "\r\n$" + add8u.cache;
            button9.Text = "Adder " + add9u.rankvalue + "\r\n$" + add9u.cache;
            button10.Text = "Adder " + add10u.rankvalue + "\r\n$" + add10u.cache;
            button11.Text = "Multipilier " + mult1u.rankvalue + "\r\n$" + mult1u.cache;
            button12.Text = "Multipilier " + mult2u.rankvalue + "\r\n$" + mult2u.cache;
            button13.Text = "Multipilier " + mult3u.rankvalue + "\r\n$" + mult3u.cache;
            button14.Text = "Multipilier " + mult4u.rankvalue + "\r\n$" + mult4u.cache;
            button15.Text = "Multipilier " + mult5u.rankvalue + "\r\n$" + mult5u.cache;
            button16.Text = "Multipilier " + mult6u.rankvalue + "\r\n$" + mult6u.cache;
            button17.Text = "Multipilier " + mult7u.rankvalue + "\r\n$" + mult7u.cache;
            button18.Text = "Multipilier " + mult8u.rankvalue + "\r\n$" + mult8u.cache;
            button19.Text = "Multipilier " + mult9u.rankvalue + "\r\n$" + mult9u.cache;
            button20.Text = "Multipilier " + mult10u.rankvalue + "\r\n$" + mult10u.cache;
            button21.Text = "Autoclickers " + autogenmultu.rankvalue + "\r\n$" + autogenmultu.cache;
            button22.Text = "Autoclicker Speed\r\n ms" + autoclickerinterval + "\r\n$" + autoclickerintervaln;
        }
        button22.Text = "Autoclicker Speed \r\n" + autoclickerinterval + "ms\r\n$" + autoclickerintervaln;
    }
    internal void updateshop() => upshopth();
